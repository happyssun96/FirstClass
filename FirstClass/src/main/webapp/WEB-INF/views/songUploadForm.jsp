	...
	<div class="songUpload-form">
		<form action="./addCtr.do" method="post">
			...
			<div class="form-group">
				<input type="text" name="song_name" placeholder="곡 이름"> <span
					class="input-icon"><i class="fas fa-music"></i></span>
			</div>
			<div class="form-group">
				<input type="text" name="album_name" placeholder="앨범명"> <span
			...
			<div class="form-group">
				<input type="text" name="music_resource_path" placeholder="음원(업로드)">
				<span class="input-icon"><i class="fas fa-headphones"></i></span>
			</div>
			<div class="form-group">
				<input type="text" name="album_image_path" placeholder="앨범표지(업로드)">
