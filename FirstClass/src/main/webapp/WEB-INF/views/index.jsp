									...
									<table class="table m-0">
										...
										<c:forEach var="songVo" items="${songList}">
											<tr>
												<td>${songVo.songNo}</td>
												<td><a
													href="userSongDetailInformation.do?no=${songVo.songNo}">
												...
												style="cursor: pointer;" onclick="youtubeFullscreen('https://www.youtube.com/watch?v=mLCsbacHxA8')">
												<input type="button" onclick="youtubeFullscreen('https://www.youtube.com/watch?v=mLCsbacHxA8')" value=" 창 열기 ">
												</i>
